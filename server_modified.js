...
// ✅ FIXED: Use dynamic port for Heroku
const PORT = process.env.PORT || 5000;

// Database setup
const dbPath = path.join(__dirname, '../database/medications.db');
const db = new sqlite3.Database(dbPath);

// ✅ FIXED: Allow all origins for deployment
app.use(cors());
...
// ✅ FIXED: Start server properly for Heroku
